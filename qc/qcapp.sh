...
javac -cp input/book.jar:input/strange-0.1.4.jar:input/strangefx-0.1.5.jar -d . --module-path ~/Documents/javafx-sdk-21.0.1/lib --add-modules javafx.graphics,javafx.controls,javafx.fxml,jdk.compiler src/*.java
