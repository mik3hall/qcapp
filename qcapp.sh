...
MODS=`jdeps --ignore-missing-deps --module-path ~/Documents/javafx-sdk-24.0.1/lib --print-module-deps input/qcapp.jar`
echo $MODS
...
javac -cp input/book.jar:input/strange-0.1.4.jar:input/strangefx-0.1.5.jar:input/stringtemplate-3.2.1.jar:input/py4j0.10.9.7.jar -d . --module-path ~/Documents/javafx-sdk-24.0.1/lib --add-modules javafx.graphics,javafx.controls,javafx.fxml,jdk.compiler src/*.java
...
${PACKAGER} \
	...
	--module-path ~/Documents/javafx-jmods-24.0.1 \
	--add-modules ${MODS},jdk.compiler,java.logging \
