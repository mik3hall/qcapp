package us.hall.test.randombitdebug;
...
public class Main {
    ...
    public static void main (String[] args) {
        ...
        //System.out.println("Showing QubitBoard " + Renderer.getRenderGroup(program));
        //Util.show(Renderer.getRenderGroup(program));
        //Util.debug(program);
        //Util.boardToXml(Renderer.getRenderGroup(program));
        
        //Platform.runLater(() -> System.out.println(
        //		new XMLDocument(Renderer.getRenderGroup(program))));
        Util.renderProgram(program, "randombitdebug");
    }
